	...
	#define ID_MENU_GAME_RELOAD_QUESTS 215
	#define ID_MENU_GAME_RELOAD_RAIDS 216
	#define ID_MENU_GAME_RELOAD_SPELLS 217
	#define ID_MENU_GAME_RELOAD_TALKACTIONS 218
	#define ID_MENU_GAME_RELOAD_RELOADALL 219
	
	#define ID_MENU_GAME_WORLDTYPE_NOPVP 220
	#define ID_MENU_GAME_WORLDTYPE_PVP 221
	#define ID_MENU_GAME_WORLDTYPE_PVPENFORCED 222
#endif
#define STATUS_SERVER_NAME "The Forgotten Server"
#define STATUS_SERVER_CODENAME "Dead Bug"
#define STATUS_SERVER_VERSION "0.2"
#define STATUS_SERVER_RELEASE_CANDIDATE "8"
