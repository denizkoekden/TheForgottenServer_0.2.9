...
class ProtocolGame : public Protocol
{
	public:
		...
		void addRuleViolation(Player* reporter, std::string message);
		void speakToReporter(std::string rname, std::string message);
		void speakToGamemaster(std::string message);
		void sendRuleViolationChannel();
		#endif
	...
	private:
		...
		#ifdef __RULEVIOLATIONREPORT__
		//rule violation report
		void removeRuleViolation(std::string rname);
		void cancelRuleViolation(std::string rname);
		void openRuleViolation(NetworkMessage& msg);
		void closeRuleViolation(NetworkMessage& msg);
		void updateRuleViolationsChannel(NetworkMessage* msg);
		#endif
