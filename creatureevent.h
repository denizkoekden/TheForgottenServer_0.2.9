...
class CreatureEvents : public BaseEvents
{
	public:
		...
		uint32_t playerThink(Player* player, uint32_t interval);
		uint32_t playerPrepareDeath(Player* player, Creature* killer);
	...
	protected:
		...
		CreatureEvent* m_thinkEvent;
		CreatureEvent* m_prepareDeathEvent;
...
class CreatureEvent : public Event
{
	public:
		...
		uint32_t executeOnThink(Player* player, uint32_t interval);
		uint32_t executeOnPrepareDeath(Player* player, Creature* killer);
		uint32_t executeOnPlayerDeath(Player* player, Creature* killer);
